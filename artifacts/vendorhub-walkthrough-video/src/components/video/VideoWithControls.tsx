...
import { ChevronDown, ChevronUp, Repeat, Download, Chrome } from 'lucide-react';
    ...
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      {!isRecording && (
        <div ref={sensorRef} className="absolute bottom-0 left-0 right-0 z-50 flex flex-col justify-end" style={{ height: '25%' }} onPointerEnter={handlePointerEnter} onPointerLeave={handlePointerLeave} onPointerDown={handlePointerDown}>
          ...
          <ControlBar visible={barVisible} collapsed={collapsed} locked={locked} sceneKeys={sceneKeys} activeIndex={activeIndex} activeDuration={activeDuration} tick={tick} onToggleLock={toggleLock} onJumpTo={jumpTo} onToggleCollapsed={handleToggleCollapsed} />
        </div>
      )}
