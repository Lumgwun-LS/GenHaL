...
const WA_CONTACTS = [
  { label: "US Office", number: "+19178218640", display: "+1 (917) 821-8640" },
  { label: "Nigeria Office", number: "+2347067246050", display: "+234 706 724 6050" },
];
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        {open && (
          ...
          >
            ...
            <p className="text-xs text-muted-foreground mb-3 leading-relaxed">
              Choose a contact below. We typically reply within a few hours.
            </p>
            <div className="space-y-2">
              {WA_CONTACTS.map((c) => (
                <a
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/20 hover:border-emerald-500/40 transition-all group"
                >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={() => setOpen((v) => !v)}
        className="w-14 h-14 rounded-full bg-emerald-500 hover:bg-emerald-400 shadow-lg shadow-emerald-500/40 flex items-center justify-center text-white transition-colors"
