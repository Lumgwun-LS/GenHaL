...
import { useListVendors, useGetFinanceOverviewAnalytics, getGetFinanceOverviewAnalyticsQueryKey } from "@workspace/api-client-react";
...
export default function FinanceAnalytics() {
  ...
  const { data, isLoading } = useGetFinanceOverviewAnalytics(params, {
    query: { enabled: Boolean(myVendor?.id), queryKey: getGetFinanceOverviewAnalyticsQueryKey(params) },
  });
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-2">Dashed portion isn't shown separately, but forecasted days extend past the selected range's end date.</p>
              </CardContent>
            </Card>
          </div>
