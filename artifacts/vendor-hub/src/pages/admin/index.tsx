...
import { ShieldCheck, ShieldOff, CreditCard, AlertCircle, CheckCircle2, XCircle, ShieldAlert } from "lucide-react";
...
export default function AdminPanel() {
  ...
  // Don't redirect until we actually know the admin status (avoids flash redirect)
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 w-full">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage vendor subscription tiers and verification levels.</p>
      </div>
                    ...
                    <TableRow key={vendor.id}>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          <KeyStatus
                            hasKey={vendor.stripe.hasKey}
                            testPassed={vendor.stripe.testPassed}
                            label="Stripe"
                          />
                          <KeyStatus
                            hasKey={vendor.paystack.hasKey}
                            testPassed={vendor.paystack.testPassed}
                            label="Paystack"
                          />
                          {vendor.featureUnlocked ? (
                            <div className="flex items-center gap-1 text-xs text-primary">
                              <ShieldCheck className="w-3.5 h-3.5" />
                              <span>Payments unlocked</span>
                            </div>
                          ) : (
                            <div className="flex items-center gap-1 text-xs text-muted-foreground">
