/**
 * Branded welcome email sent to new super-admin / admin accounts on
 * Awa Biz Suite and Awajimaa App Store.
 */
...
export interface WelcomeEmailOpts {
  ...
  name: string;
  roles?: string[];
  platform?: "biz-suite" | "app-store" | "both";
}

export async function sendAdminWelcomeEmail(opts: WelcomeEmailOpts): Promise<void> {
  const { to, name, roles = ["SUPER_ADMIN", "ADMIN", "AWAJIMA"], platform = "both" } = opts;

  const platformLabel =
    platform === "biz-suite" ? "Awa Biz Suite"
    : platform === "app-store" ? "Awajimaa App Store"
    : "Awa Biz Suite & Awajimaa App Store";
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f8;padding:40px 0;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td>
                ...
                <p style="margin:8px 0 0;font-size:14px;color:rgba(255,255,255,0.88);">Your super-admin account is ready on <strong>${platformLabel}</strong>.</p>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td style="padding:32px 40px 20px;">
          <p style="margin:0 0 18px;font-size:15px;color:#333;line-height:1.6;">
            ...
            Your account credentials and roles are set up and ready to use.
          </p>
          ...
          <p style="margin:0 0 20px;font-size:14px;color:#444;font-weight:600;">Our Platforms</p>

          <!-- Platform links grid -->
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr>
              <td width="48%" style="padding:0 6px 12px 0;vertical-align:top;">
                <div style="background:#f9f9fc;border-radius:10px;padding:14px 16px;border-left:4px solid #7F50FF;">
                  <p style="margin:0 0 4px;font-size:12px;font-weight:700;color:#7F50FF;text-transform:uppercase;">Lumgwun Solutions</p>
                  <a href="https://lumgwunsolutions.com" style="font-size:13px;color:#333;text-decoration:none;">lumgwunsolutions.com</a>
                </div>
              </td>
              <td width="48%" style="padding:0 0 12px 6px;vertical-align:top;">
                <div style="background:#f9f9fc;border-radius:10px;padding:14px 16px;border-left:4px solid #FF7F50;">
                  <p style="margin:0 0 4px;font-size:12px;font-weight:700;color:#FF7F50;text-transform:uppercase;">Awajimaa Schools</p>
            ...
            <tr>
              <td width="48%" style="padding:0 6px 12px 0;vertical-align:top;">
                <div style="background:#f9f9fc;border-radius:10px;padding:14px 16px;border-left:4px solid #7F50FF;">
                  <p style="margin:0 0 4px;font-size:12px;font-weight:700;color:#7F50FF;text-transform:uppercase;">Awajimaa Hosting</p>
                  <a href="https://awajimaahosting.com" style="font-size:13px;color:#333;text-decoration:none;">awajimaahosting.com</a>
                </div>
              </td>
              <td width="48%" style="padding:0 0 12px 6px;vertical-align:top;">
                <div style="background:#f9f9fc;border-radius:10px;padding:14px 16px;border-left:4px solid #FF7F50;">
                  <p style="margin:0 0 4px;font-size:12px;font-weight:700;color:#FF7F50;text-transform:uppercase;">Awajimaa AI</p>
            ...
            <tr>
              <td colspan="2" style="padding:0 0 12px 0;vertical-align:top;">
                <div style="background:#f9f9fc;border-radius:10px;padding:14px 16px;border-left:4px solid #7F50FF;">
                  <p style="margin:0 0 4px;font-size:12px;font-weight:700;color:#7F50FF;text-transform:uppercase;">Awajimaa App</p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="33%" style="padding:0 4px 8px 0;">
                      <a href="https://www.instagram.com/lumgwunsolutionsgroup" style="display:block;background:#f9f9fc;border-radius:8px;padding:10px 12px;text-decoration:none;text-align:center;">
                        <span style="font-size:18px;">📸</span><br>
                        <span style="font-size:11px;color:#555;font-weight:600;">Instagram</span>
                      </a>
                    </td>
                    <td width="33%" style="padding:0 4px 8px;">
                      <a href="https://tiktok.com/@lumgwun.solutions" style="display:block;background:#f9f9fc;border-radius:8px;padding:10px 12px;text-decoration:none;text-align:center;">
                        <span style="font-size:18px;">🎵</span><br>
                        <span style="font-size:11px;color:#555;font-weight:600;">TikTok</span>
                      </a>
                    </td>
                    <td width="33%" style="padding:0 0 8px 4px;">
                      <a href="https://t.me/AwaApp" style="display:block;background:#f9f9fc;border-radius:8px;padding:10px 12px;text-decoration:none;text-align:center;">
                        <span style="font-size:18px;">✈️</span><br>
                        <span style="font-size:11px;color:#555;font-weight:600;">Telegram</span>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    <td width="33%" style="padding:0 4px 0 0;">
                      <a href="https://web.facebook.com/LUMGWUNSOLUTIONS/" style="display:block;background:#f9f9fc;border-radius:8px;padding:10px 12px;text-decoration:none;text-align:center;">
                        <span style="font-size:18px;">👤</span><br>
                        <span style="font-size:11px;color:#555;font-weight:600;">Facebook</span>
                      </a>
                    </td>
                    <td width="33%" style="padding:0 4px;">
                      <a href="https://www.linkedin.com/company/lumgwun-solutions-group/" style="display:block;background:#f9f9fc;border-radius:8px;padding:10px 12px;text-decoration:none;text-align:center;">
                        <span style="font-size:18px;">💼</span><br>
                        <span style="font-size:11px;color:#555;font-weight:600;">LinkedIn</span>
                      </a>
                    </td>
                    <td width="33%" style="padding:0 0 0 4px;">
                      <a href="https://x.com/awajimaaApp" style="display:block;background:#f9f9fc;border-radius:8px;padding:10px 12px;text-decoration:none;text-align:center;">
                        <span style="font-size:18px;">𝕏</span><br>
                        <span style="font-size:11px;color:#555;font-weight:600;">X / Twitter</span>
                      </a>
                    </td>
                  </tr>
                </table>
          ...
          <div style="background:#f4f4f8;border-radius:10px;padding:18px 20px;margin-bottom:12px;">
            ...
            <p style="margin:0 0 6px;font-size:13px;color:#444;">
              📍 <strong>USA:</strong> 16501 Shady Grove Road, Suite 8885, Gaithersburg, MD 20898
            </p>
            <p style="margin:0 0 6px;font-size:13px;color:#444;">
              📍 <strong>Nigeria:</strong> Pyale Workhub, 21 Bekwere Wosu Street, D-Line, Diobu, Port Harcourt, Rivers State
            </p>
            <p style="margin:0 0 6px;font-size:13px;color:#444;">
              📞 +1 917 821 8640 &nbsp;|&nbsp; +234 703 884 3102
            </p>
            <p style="margin:0;font-size:13px;color:#444;">
              ✉️ <a href="mailto:admin@lumgwunsolutions.com" style="color:#7F50FF;">admin@lumgwunsolutions.com</a>
              &nbsp;|&nbsp;
      ...
      <tr>
        <td style="background:#faf9ff;padding:20px 40px 28px;border-top:1px solid #ede8ff;">
          <p style="margin:0 0 8px;font-size:12px;color:#999;text-align:center;">
            © 2025 Lumgwun Solutions &amp; Awajimaa Group. All rights reserved.
          </p>
  ...
  const text = `Welcome to the Awajimaa Platform, ${name}!

Your super-admin account is now active on ${platformLabel}.
Roles: ${roles.join(", ")}
...
X / Twitter: https://x.com/awajimaaApp
...
Privacy Policy: https://docs.google.com/document/d/1GQ7NOKDXFORu1vLKtP7EMpXZlIA1NIR6/edit
`;
  ...
  try {
    ...
    logger.info({ to, result }, "[welcome-email] Admin welcome email dispatched");
  } catch (err) {
    logger.warn({ err, to }, "[welcome-email] Failed to send admin welcome email");
  }
}
