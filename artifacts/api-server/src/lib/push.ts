 ...
 */
export type PushCategory = "payments" | "voice_campaigns" | "post_reminders" | "ai_media_expiry" | "facebook_video";
...
const PUSH_CATEGORY_COLUMN = {
  ...
  facebook_video: vendorsTable.pushFacebookVideoAlertsEnabled,
} as const;
