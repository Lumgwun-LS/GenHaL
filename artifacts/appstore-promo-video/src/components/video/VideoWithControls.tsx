...
import { Repeat, Volume2, VolumeX, ChevronDown, ChevronUp, Download, Chrome } from 'lucide-react';
      ...
      {sceneKeys.map((key, i) => {
        ...
        return (
          <button
            ...
            aria-label={`Jump to scene: ${labels[key] ?? key}`}
...
export default function VideoWithControls() {
  ...
  // Export path — no controls, recording lifecycle intact
  if (isIframed) {
    return (
  ...
  return (
    <div className="flex flex-col w-full h-screen bg-black">
      {/* Video — fills remaining space; when recording takes full height */}
      ...
      {/* Control bar sits below the video — hidden during recording */}
      {!isRecording && (
        <div ref={sensorRef} onPointerEnter={handlePointerEnter} onPointerLeave={handlePointerLeave} onPointerDown={handlePointerDown}>
